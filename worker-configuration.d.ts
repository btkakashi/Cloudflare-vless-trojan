/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging` (hash: 202c78136fc1a854fbe16069ba898471)
// Runtime types generated with workerd@1.20260911.1 2026-09-13 nodejs_compat
interface __BaseEnv_Env {
	PROXY_POOL: KVNamespace;
	proxyip: "proxyip.hk.fxxk.dedyn.io,proxyip.jp.fxxk.dedyn.io";
	PROXY_CONCURRENT_DIAL: "2";
	CONNECT_TIMEOUT_MS: "1800";
	FIRST_BYTE_TIMEOUT_MS: "3000";
	ALLOW_PATH_PROXYIP: "false";
	DEBUG: "false";
	PROXY_DISCOVERY_HOSTS: "proxyip.hk.fxxk.dedyn.io,proxyip.jp.fxxk.dedyn.io";
	PROXY_DISCOVERY_SAMPLE_SIZE: "24";
	PROXY_POOL_SIZE: "6";
	PROXY_PROBE_CONCURRENCY: "4";
	PROXY_PROBE_TIMEOUT_MS: "1500";
	PROXY_POOL_MAX_AGE_MS: "86400000";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "proxyip" | "PROXY_CONCURRENT_DIAL" | "CONNECT_TIMEOUT_MS" | "FIRST_BYTE_TIMEOUT_MS" | "ALLOW_PATH_PROXYIP" | "DEBUG" | "PROXY_DISCOVERY_HOSTS" | "PROXY_DISCOVERY_SAMPLE_SIZE" | "PROXY_POOL_SIZE" | "PROXY_PROBE_CONCURRENCY" | "PROXY_PROBE_TIMEOUT_MS" | "PROXY_POOL_MAX_AGE_MS">> {}
}
